...
>- `alpha10` is a constant for the initial value of parameter α<sup>1</sup>, set to 0 by default (alpha10=NA)
>- `alpha20` is a constant for the initial value of parameter α<sup>2</sup>, set to 0 by default (alpha20=NA)
